...
namespace SqliteSharp
{
	...
	{
		public static int sqlite3_auto_extension(delegate14 xInit)
		{
			int rc = (int)(0);
		...
		public static int sqlite3_cancel_auto_extension(delegate14 xInit)
		{
			sqlite3_mutex* mutex = sqlite3MutexAlloc((int)(2));
			int i = 0;
			int n = (int)(0);
		...
		public static void sqlite3BenignMallocHooks(delegate14 xBenignBegin, delegate14 xBenignEnd)
		{
